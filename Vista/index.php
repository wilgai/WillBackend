                ...
                <div class="navbar-header">
                   ...
                   <!-- <div class="navbar-brand">-->
                        <a class="smooth-scroll" data-section="#home" href="#home" >
                            <img src="images/logo2.png" width="200px" alt="100x">
                        </a>
                    <!--</div>-->
                    <!-- /logo -->
                </div>
                ...
                <nav class="collapse navbar-collapse navbar-right" role="navigation">
                    <div class="main-menu">
                        <ul id="nav" class="nav navbar-nav">
                            ...
                            <li class="scroll"><a href="#login" data-section="#login">Ingresar</a></li>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="carousel-content text-center">
                                    <h2>Facturacion online <span>Wilgaisoft</span>.</h2>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et  dolore magna incididunt ut labore aliqua. </p>
                                    <a class="btn btn-primary btn-lg" href="registrar.php">Crear una Cuenta Gratis</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="carousel-content text-center">
                                    ...
                                    <h2>Facturacion online <span>Clients</span></h2>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et  dolore magna incididunt ut labore aliqua. </p>
                                    <a class="btn btn-primary btn-lg" href="registrar.php">Crear una Cuenta Gratis</a>
                                </div>
                            </div>
    ...
    <footer id="footer">
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <p class="text-center">
                        &copy; 2017 Wilgaisoft. Desarrollado por <a target="_blank" href="#" title="">Wilgai Lorimer Estudiante de UTESA Ciclo 3-2017</a>
                    </p>
